...
const SSCML = () => {
    ...
    useEffect(() => {
        ...
        axios.get(`http://192.168.7.15:8081/customTableDataSSCML`, config)
...
const paymentNames = [...new Set(customdata.map(item => item.PAYMENT_METHOD))];
    ...
    return (
        ...
        //             </a>
        //             <div className='nav'>
        //                 <Link to='/Labanchora_SEND' style={{ textDecoration: 'none' }}><button type="button" className="btn btn-success" style={{ color: 'white' }}>Send Notification</button></Link>&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        //         </div>
        //     </nav >
        //     <h1 className='mt-4 text-2xl text-center font-bold text-teal-600'>Shun Shing Cement Mills Ltd.</h1>
        //     <div className='container'>
...
<nav className="bg-blue-100">
        ...
        <div className="relative flex h-16 items-center justify-between">
            ...
            <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div className="hidden sm:ml-6 sm:block">
                    <Link to='/Labanchora_SEND' style={{ textDecoration: 'none' }}><button type="button" className="btn btn-success" style={{ color: 'white' }}>Cash Payment</button></Link>&nbsp;&nbsp;&nbsp;&nbsp;
                    {/* <Link to='' style={{ textDecoration: 'none' }}><button type="button" className="btn btn-warning" style={{ color: 'white' }}>iExpense</button></Link>&nbsp;&nbsp;&nbsp;&nbsp; */}
    ...
    <div className={`sm:hidden ${isMenuOpen ? '' : 'hidden'}`} id="mobile-menu">
        ...
        <Link to='/Labanchora_SEND' style={{ textDecoration: 'none' }}><button type="button" className="btn btn-success" style={{ color: 'white' }}>Cash Payment</button></Link><br />
        {/* <Link to='' style={{ textDecoration: 'none' }}><button type="button" className="btn btn-warning" style={{ color: 'white' }}>iExpense</button></Link>&nbsp;&nbsp;&nbsp;&nbsp; */}
