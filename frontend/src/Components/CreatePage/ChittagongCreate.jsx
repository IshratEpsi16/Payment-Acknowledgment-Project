...
const ChittagongCreate = () => {
    ...
    useEffect(() => {
        ...
        axios.get('http://192.168.7.15:8081/ctg')
            .then(res => {
    ...
    useEffect(() => {
        ...
        axios.get('http://192.168.7.15:8081/ctg', config)
    ...
    function handleSubmit(event) {
        ...
        axios.put(`http://192.168.7.15:8081/updateStatusCtg/${PAYEE_ID}/${PAYROLL_MONTH}`, {}, config)
            .then(res => {
...
<nav className="navbar bg-blue-100">
    <div className="container flex justify-between items-center">
        ...
        <div className='text-danger'>
            <Link to='/chittagong' className='text-danger'>
...
export default ChittagongCreate;