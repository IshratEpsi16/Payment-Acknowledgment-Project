...
const SSCILCreate = () => {
    ...
    useEffect(() => {
        ...
        axios.get('http://192.168.7.15:8081/SSCIL')
            .then(res => {
    ...
    useEffect(() => {
        ...
        axios.get('http://192.168.7.15:8081/SSCIL', config)
    ...
    function handleSubmit(event) {
        ...
        axios.put(`http://192.168.7.15:8081/updateStatusSSCIL/${PAYEE_ID}/${PAYROLL_MONTH}`, {}, config)
            .then(res => {
...
<div>
            <nav className="navbar bg-blue-100">
                <div className="container flex justify-between items-center">
                    ...
                    <div className='text-danger'>
                        <Link to='/shikolbaha' className='text-danger'>
