...
SELECT DUPLICATE_PAYMENT_CHECK(:P_PAYEE_ID,:P_PERIOD_NAME) VALIDATION FROM XXCRM.XXSSGIL_CASH_PAY_DET WHERE 
PAYEE_ID=:P_PAYEE_ID AND CURRENT_PERIOD=:P_PERIOD_NAME